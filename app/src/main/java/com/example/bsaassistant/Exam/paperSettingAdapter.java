...
public class paperSettingAdapter  extends RecyclerView.Adapter<paperSettingAdapter.ViewHolder> {
    Context context;
    ...
    paperSettingAdapter(Context context,ArrayList<Integer>sr,ArrayList<String>subjArr,ArrayList<String>dateArr,ArrayList<Integer>nosArr,ArrayList<Integer>rateArr){
